...
onMounted(() => {
    ...
    navigationBar.addEventListener('click', () => {
        if(navigationContents.style.maxHeight != '500px') {
            ...
            navigationContents.style.maxHeight = '500px'
        } else {
...
<template>
    <nav class="sticky top-0 px-4 sm:px-12 md:px-24 lg:px-48 bg-zinc-700 py-2 text-white duration-150" id="nav">
        <div class="flex gap-2 rounded-b items-center w-full">
            ...
            <div class="w-full" id="navWrapper">
                <div class="w-full flex flex-col rounded drop-shadow-none duration-150 bg-zinc-800 hover:bg-slate-600 hover:drop-shadow-md" id="navigationBar">
                    ...
                    <div class="flex flex-col top-9 w-full absolute duration-500 max-h-0 overflow-hidden rounded-b bg-zinc-800" id="navigationContents">
