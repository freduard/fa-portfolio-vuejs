...
export const projects = [
    ...
    },
    {
        ...
        p1: "Sain Andresega läbi oma venna tuttavaks, kui ta oli maininud e-portfoolio vajadust. See oli minu esimene päris projekt ja veebiarenduse tööots mida ma sel ajal teinud olin. Alguses mõtlesin, et see on lihtne ja kiire paarinädala töö mis on osutus täiesti vastupidiseks.",
        p2: "Algselt ainukene asi mida ma kasutasin oli TailwindCSS ilma ühegi raamistikuta, mis oli suur viga elementide paigutuse tõttu, kuna elementide klasside read tulid väga massiivsed mistõttu oli ka koodist lõpuks raske aru saada.",
        p3: "Paratamatult pidin ma terve projekti port'ima Vue.js raamistiku peale ja ümber ehitama terve saidi back-end'i süsteemi mis oli pehmelt öeldes piinarikas.",
    },
    {
        id: 6,
        // date: "Aprill 6, 2022",
